...
let btn_style = document.getElementById("cont_btn");
...
btn_cont.addEventListener("click",updateDisplay);
...
function init() 
{
    btn_cont.setAttribute("href", "javascript:void(0);");
}
